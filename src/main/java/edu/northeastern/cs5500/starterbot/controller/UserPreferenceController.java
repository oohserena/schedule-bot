...
public class UserPreferenceController {
    ...
    /**
     * After user input the prefername command, they can set their prefer name
     *
     * @param discordMemberId discord user id
     * @param preferredName name user prefered
     */
    ...
    /** Get user's prefered name according to their discord Id */
    @Nullable
